    ...
    def run_model(self):
        ...
        if self.phase == 'train':
            ...
            callbacks = [
                         ...
                         ModelCheckpoint(config.run_dir + '/weights_e{epoch:04d}_loss{loss:.4f}_val_loss{val_loss:.4f}_seg_loss{seg_loss_loss:.4f}_re_loss{re_loss_loss:.4f}_class_loss{class_loss_loss:.4f}_val_seg{val_seg_loss_loss:.4f}_val_re{val_re_loss_loss:.4f}_val_clas{val_class_loss_loss:.4f}.h5', verbose=1,
